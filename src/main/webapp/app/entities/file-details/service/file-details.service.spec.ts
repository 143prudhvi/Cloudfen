  ...
  describe('Service methods', () => {
    ...
    describe('addFileDetailsToCollectionIfMissing', () => {
      ...
      it('should add only unique FileDetails to an array', () => {
        const fileDetailsArray: IFileDetails[] = [{ id: 123 }, { id: 456 }, { id: 92935 }];
      ...
      it('should return initial array if no FileDetails is added', () => {
        const fileDetailsCollection: IFileDetails[] = [{ id: 123 }];
        expectedResult = service.addFileDetailsToCollectionIfMissing(fileDetailsCollection, undefined, null);
        expect(expectedResult).toEqual(fileDetailsCollection);
      });
    });
  });
