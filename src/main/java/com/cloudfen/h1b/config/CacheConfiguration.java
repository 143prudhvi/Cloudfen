...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.cloudfen.h1b.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.cloudfen.h1b.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.cloudfen.h1b.domain.FileDetails.class.getName());
