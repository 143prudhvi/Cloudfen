...
describe('BioProfile e2e test', () => {
  ...
  it('should load BioProfiles', async () => {
    ...
    expect(await bioProfileComponentsPage.getTitle()).to.eq('cloudfenApp.bioProfile.home.title');
  ...
  it('should load create BioProfile page', async () => {
    ...
    expect(await bioProfileUpdatePage.getPageTitle()).to.eq('cloudfenApp.bioProfile.home.createOrEditLabel');
  ...
  it('should delete last BioProfile', async () => {
    ...
    expect(await bioProfileDeleteDialog.getDialogTitle()).to.eq('cloudfenApp.bioProfile.delete.question');
