...
class FileDetailsResourceIT {
    ...
    public static FileDetails createEntity(EntityManager em) {
        FileDetails fileDetails = new FileDetails().userName(DEFAULT_USER_NAME).type(DEFAULT_TYPE).fileName(DEFAULT_FILE_NAME);
        return fileDetails;
    }
    ...
    public static FileDetails createUpdatedEntity(EntityManager em) {
        FileDetails fileDetails = new FileDetails().userName(UPDATED_USER_NAME).type(UPDATED_TYPE).fileName(UPDATED_FILE_NAME);
        return fileDetails;
    }
    ...
    void putNewFileDetails() throws Exception {
        ...
        updatedFileDetails.userName(UPDATED_USER_NAME).type(UPDATED_TYPE).fileName(UPDATED_FILE_NAME);
    ...
    void partialUpdateFileDetailsWithPatch() throws Exception {
        ...
        partialUpdatedFileDetails.type(UPDATED_TYPE);
    ...
    void fullUpdateFileDetailsWithPatch() throws Exception {
        ...
        partialUpdatedFileDetails.userName(UPDATED_USER_NAME).type(UPDATED_TYPE).fileName(UPDATED_FILE_NAME);
